const Footer = () => {
  ...
  return (
    <footer className="text-gray-500 bg-neutral-900 px-4 py-3 max-w-screen-2xl md:px-8 border-t shadow-[0_-4px_6px_theme('colors.neutral.800')] border-neutral-700">
      <div className="max-w-4xl sm:mx-auto sm:text-center">
        <img src="/logo.png" className="w-20 sm:mx-auto" />
        <p className="leading-relaxed mt-2 text-[15px]">
          ComicNest is your gateway to an ever-expanding universe of comics,
          creators, and fans. Whether you're into superheroes, indie art, or
          manga masterpieces, ComicNest lets you explore, read, and follow your
          favorite stories — all in one place. Join the nest, and experience
          comics like never before.
        </p>
      </div>
      <ul className="items-center justify-center mt-6 space-y-3 sm:flex sm:space-x-4 sm:space-y-0">
      ...
      <div className="mt-2 items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0">
          &copy; {new Date().getFullYear()} ComicNest. All rights reserved.
        </div>
